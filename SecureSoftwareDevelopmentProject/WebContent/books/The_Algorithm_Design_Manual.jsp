...
<sql:setDataSource var = "snapshot" driver = "com.mysql.jdbc.Driver"
      ...
      <sql:query dataSource = "${snapshot}" var = "result">
            SELECT * from books where title='The_Algorithm_Design_Manual';
      </sql:query>

<h1>The Algorithm Design Manual</h1>
<h2>Steven Skiena</h2>
<img src ="https://images-na.ssl-images-amazon.com/images/I/5186uqUuDUL._SX376_BO1,204,203,200_.jpg"><br/>

<form action="/action_page.php" method="get">
<c:forEach var = "row" items = "${result.rows}">
            <tr align="center">
               <p><b>The Algorithm Design Manual</b></br>
